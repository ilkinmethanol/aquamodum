...
class WaterQualityIndex(models.Model):
	...
	axarin_tipi = models.CharField(max_length=20,choices=axar_choices)
	...
	wqi = models.FloatField(null=True,blank=True)
